...
import tour.base.constant.Constant;
import tour.base.enumerate.HttpStatusCodeService;
import tour.base.enumerate.HttpStatusEnum;
...
public class ApiResponse<T> implements Serializable {
    ...
    public ApiResponse(String reCode, String reMsg,Long userId) {
        this.reCode = reCode;
        this.reMsg = reMsg;
